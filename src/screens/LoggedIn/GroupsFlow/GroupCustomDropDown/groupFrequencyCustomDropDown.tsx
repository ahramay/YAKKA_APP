...
const GroupFrequencyCustomDropDown: React.FC<DropdownProps> = (props: DropdownProps) => {
    const { option, onSelect, height = 150, placeHolder = 'Select option', width = '93%', multiSelect = false} = props
    ...
    const handleSelect = (idx: number, value: string) => {
        ...
        if (updatedSelections.includes(value)) {
            ...
            if (multiSelect && updatedSelections.length < 1) {
                // Select the option
...
export default GroupFrequencyCustomDropDown;
